...
# Author: Dragon Xu
# Description: This is a Streamlit app that visualizes the QS World University Rankings data.
# The app allows users to filter the data by year, university type, university size, and region.
...
# Set Up
country_codes = pd.read_csv('https://raw.githubusercontent.com/CristoDragon/Visualization_Projects/refs/heads/main/Type1/Dashboard1/Data/country_codes.csv' ,sep=',', encoding='latin-1')
